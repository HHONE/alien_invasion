...
def get_number_rows(ai_settings,ship_heigth,alien_heigth):
    available_spaces_y=(ai_settings.screen_heigth-(3*alien_heigth)-ship_heigth)
    number_rows=int(available_spaces_y/(2*alien_heigth))
    return number_rows
...
def change_fleet_direction(ai_settings,aliens):
    for alien in aliens.sprites():
        alien.rect.y+=ai_settings.fleet_drop_spreed
